...
const Parts = () => {
    ...
    return (
        <div className='my-16 lg:mx-8 md:mx-4 sm:mx-4'>
            <h2 className='text-3xl text-secondary font-bold relative'>Motorbike Spare Parts <span className='bg-warning absolute left-80 top-2 text-xs font-semibold py-1 px-2 text-secondary border-2 border-secondary border-dashed inline-block'>SALE !</span></h2>
