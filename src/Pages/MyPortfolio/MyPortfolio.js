        ...
        <div className="hero min-h-screen bg-base-100">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <h1 className="text-xl">salman.dnj@gmail.com</h1>
                    <h1 className="text-2xl font-bold">Educational Background:<br></br><span className='text-lg font-normal'> Bachelor of Science <br></br>Geography and Environmental Science<br></br>
                        Begum Rokeya University, Rangpur.<br></br>
                        Rangpur, Bangladesh
                    </span></h1>
                    <h1 className="text-2xl font-bold">Skill Highlights:<br></br><span className='text-lg font-normal'> Expertise: JavaScript, ES6, React.js, React Router, React Hook, SPA, HTML5, CSS3, Bootstrap-5, Tailwind CSS, Firebase.
                    ...
                    <h1 className="text-2xl font-bold">Project:<br></br><span className='text-lg font-normal'>1. Genius Car Services <a href="https://genius-car-services-ddc8e.web.app/" target="_blank" className='btn btn-xs btn-secondary'>Live Website link</a>
